...
## Desafio de projeto
Utilizar meus conhecimentos adquiridos no módulo de fundamentos, da trilha .NET da DIO.
...
Resumindo, desenvolvi um menu interativo com as seguintes ações implementadas:
1. Cadastrar veículo
2. Remover veículo
3. Listar veículos
4. Encerrar
...
## Solução
Desafio solucionado com sucesso!
